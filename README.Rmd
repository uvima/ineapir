...
The official repository has been moved to [es-ine/ineapir](https://github.com/es-ine/ineapir).
To install the development version of **ineapir** 

```{r, eval = FALSE}
remotes::install_github("es-ine/ineapir")
```

Alternatively, you can download the source code as a zip file and then install
it as follows.
