...
## Obtaining an identification code from a table
...
- **ID:** concatenate parameters *path* and *file* into one single ID
...
## Obtaining an identification code from a series
